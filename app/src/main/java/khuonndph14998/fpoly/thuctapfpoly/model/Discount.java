...
public class Discount {
    private String dc_name,dc_code,dc_time,dc_note,dc_img;
    private int dc_quantity,dc_price;

    public Discount() {
    }

    public Discount(String dc_name, String dc_code, String dc_time, String dc_note, String dc_img, int dc_quantity, int dc_price) {
