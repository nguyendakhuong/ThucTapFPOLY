...
public class CategoryJeansFragment extends Fragment implements ItemProductListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_category_jeans, container, false);
        rclView_cardProductAll = view.findViewById(R.id.cardProduct_rclView_Jeans);
    ...
    private void loadProducts() {
        ...
        Query query = productsRef.orderByChild("selectedItem").equalTo("Quần bò");
